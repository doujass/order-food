package com.orderfood.pedidos.controller;

import com.orderfood.pedidos.dto.PedidoDto;
import com.orderfood.pedidos.dto.StatusDto;
import com.orderfood.pedidos.service.PedidoService;
...
public class PedidoController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<PedidoDto> excluirPedido(@PathVariable @NotNull Long id) {
